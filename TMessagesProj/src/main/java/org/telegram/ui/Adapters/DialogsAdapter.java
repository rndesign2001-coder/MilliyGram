...
//        }
    ...
    public class LastEmptyView extends FrameLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            boolean hasArchive = folderId == 0 && DialogsActivity.mgArchiveType(dialogsType) && MessagesController.getInstance(currentAccount).dialogs_dict.get(DialogObject.makeFolderDialogId(1)) != null;
